...
training_file = os.path.join(current_dir, 'Data', 'Training.csv')
testing_file = os.path.join(current_dir, 'Data', 'Testing.csv')
description_file = os.path.join(current_dir, 'MasterData', 'symptom_Description.csv')
severity_file = os.path.join(current_dir, 'MasterData', 'Symptom_severity.csv')
precaution_file = os.path.join(current_dir, 'MasterData', 'symptom_precaution.csv')
